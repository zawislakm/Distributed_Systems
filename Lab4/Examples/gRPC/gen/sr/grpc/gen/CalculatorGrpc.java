...
public final class CalculatorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<sr.grpc.gen.ArithmeticMulArguments,
      sr.grpc.gen.ArithmeticOpResult> getMultipleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Multiple",
  ...
  public static io.grpc.MethodDescriptor<sr.grpc.gen.ArithmeticMulArguments,
      sr.grpc.gen.ArithmeticOpResult> getMultipleMethod() {
    io.grpc.MethodDescriptor<sr.grpc.gen.ArithmeticMulArguments, sr.grpc.gen.ArithmeticOpResult> getMultipleMethod;
    if ((getMultipleMethod = CalculatorGrpc.getMultipleMethod) == null) {
      synchronized (CalculatorGrpc.class) {
        if ((getMultipleMethod = CalculatorGrpc.getMultipleMethod) == null) {
          CalculatorGrpc.getMultipleMethod = getMultipleMethod =
              io.grpc.MethodDescriptor.<sr.grpc.gen.ArithmeticMulArguments, sr.grpc.gen.ArithmeticOpResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Multiple"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sr.grpc.gen.ArithmeticMulArguments.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sr.grpc.gen.ArithmeticOpResult.getDefaultInstance()))
              .setSchemaDescriptor(new CalculatorMethodDescriptorSupplier("Multiple"))
              .build();
        }
      }
    }
    return getMultipleMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void multiple(sr.grpc.gen.ArithmeticMulArguments request,
        io.grpc.stub.StreamObserver<sr.grpc.gen.ArithmeticOpResult> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMultipleMethod(), responseObserver);
    }
  }
  ...
  public static final class CalculatorStub
    ...
    public void multiple(sr.grpc.gen.ArithmeticMulArguments request,
        io.grpc.stub.StreamObserver<sr.grpc.gen.ArithmeticOpResult> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getMultipleMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class CalculatorBlockingStub
    ...
    /**
     */
    public sr.grpc.gen.ArithmeticOpResult multiple(sr.grpc.gen.ArithmeticMulArguments request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getMultipleMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class CalculatorFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sr.grpc.gen.ArithmeticOpResult> multiple(
        sr.grpc.gen.ArithmeticMulArguments request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getMultipleMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_ADD = 0;
  private static final int METHODID_SUBTRACT = 1;
  private static final int METHODID_MULTIPLE = 2;
      ...
      switch (methodId) {
        ...
        case METHODID_SUBTRACT:
          serviceImpl.subtract((sr.grpc.gen.ArithmeticOpArguments) request,
              (io.grpc.stub.StreamObserver<sr.grpc.gen.ArithmeticOpResult>) responseObserver);
          break;
        case METHODID_MULTIPLE:
          serviceImpl.multiple((sr.grpc.gen.ArithmeticMulArguments) request,
              (io.grpc.stub.StreamObserver<sr.grpc.gen.ArithmeticOpResult>) responseObserver);
          break;
        default:
